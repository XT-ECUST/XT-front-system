            ...
            <div class="login-form">
                <el-form :model="user" label-width="auto" ref="userRef" :rules="rules" style="max-width: 450px">
                    ...
                    <el-form-item prop="password">
                        <el-input type="password" v-model="user.password" placeholder="请输入密码" minlength="6"
                            maxlength="16" @keyup.enter.native="handleLogin(userRef)">
                            <template #prepend>
                                <el-icon>
                                    <Lock />
                                </el-icon>
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="handleLogin(userRef)" class="login-btn"
