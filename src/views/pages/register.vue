            ...
            <div class="register-form">
                <el-form :model="registerForm" label-width="auto" ref="registerRef" :rules="rules" style="max-width: 450px">
                    <el-form-item prop="jobnumber">
                        <el-input v-model="registerForm.jobnumber" placeholder="请输入8位工号" maxlength="8">
                            <template #prepend>
                                <el-icon>
                                    <User />
                                </el-icon>
                    ...
                    <el-form-item prop="password">
                        <el-input type="password" v-model="registerForm.password" placeholder="请输入密码" minlength="6"
                            maxlength="16" @keyup.enter.native="handleRegister(registerRef)">
                            <template #prepend>
                                <el-icon>
                                    <Lock />
                                </el-icon>
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="handleRegister(registerRef)" class="register-btn"
